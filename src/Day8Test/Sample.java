...
public class Sample
{
    ...
    public static final List<Coord> Coords = List.of(
            new Coord(162,817,812),
            new Coord(57,618,57),
            new Coord(906,360,560),
            new Coord(592,479,940),
            new Coord(352,342,300),
            new Coord(466,668,158),
            new Coord(542,29,236),
            new Coord(431,825,988),
            new Coord(739,650,466),
            new Coord(52,470,668),
            new Coord(216,146,977),
            new Coord(819,987,18),
            new Coord(117,168,530),
            new Coord(805,96,715),
            new Coord(346,949,466),
            new Coord(970,615,88),
            new Coord(941,993,340),
            new Coord(862,61,35),
